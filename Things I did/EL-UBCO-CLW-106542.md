...
* CV Background Segmenter Workshop: (Kyra)
...
* LearnCoding: Meeting with Engineering (Thomas + Dean) - they want to switch to Python for first year, then their Design Studio Course will use C++. Students now need to be able to switch from Python to C++ and to Java. --> they want to use LC for helping students.  
